      ...
      <div className="mx-auto max-w-screen-xl px-4 py-24 lg:flex lg:h-screen grid">
        <div className="mx-auto max-w-xl text-center self-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            ...
            <a
              className="block w-full rounded px-12 py-3 text-sm font-medium text-primary shadow hover:bg-blue-600 hover:text-white transition-all focus:outline-none focus:ring active:text-red-500 sm:w-auto"
              href="#"
            >
              Learn More
            </a>
